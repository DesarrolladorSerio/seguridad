...
DEFAULT_FORWARD_HOST = "192.168.56.10"
...
def attempt_decrypt_without_key(data: bytes):
    """Intenta descifrar sin la clave correcta, demostrando que falla."""
...
class MITMProxy(threading.Thread):
    ...
    def run(self):
        ...
        try:
            ...
            # reenviar al C2 sin modificar (si se modificara, el tag GCM fallaría)
